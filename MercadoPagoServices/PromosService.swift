...
open class PromosService: MercadoPagoService {
	...
	open func getPromos(_ url: String = PXServicesURLConfigs.MP_PROMOS_URI, method: String = "GET", public_key: String, success: @escaping (_ data: Data?) -> Void, failure: ((_ error: NSError) -> Void)?) {
